...
ggsave("Figure4-CorrelationbyID", width = 11.5, height = 5,unit =  "in", plot = plot1, path="./figures", device = "tiff",dpi = 300)

ggsave("Figure4-CorrelationbyID.png", width = 7, height = 5.5,unit =  "in", plot = plot1, path="./figures", device = "png",dpi = 300)
  
E3=ggarrange(plot1,plot2,nrow=1)
ggsave("Figure5-LowvHighIDPairs.tiff", width = 11.5, height = 6,unit =  "in", plot = E3, path="./figures/", device = "tiff",dpi = 300)
